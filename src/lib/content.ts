...
import { SEED_TOPICS_FINAL_POPULATION } from "@/data/seed-topics-final-population";

const ALL_SEED_TOPICS: Topic[] = [
...
export async function getTopicById(topicId: string): Promise<Topic | null> {
    const seed = ALL_SEED_TOPICS.find(t => t.id === topicId);
    if (seed) return seed;
    try {
...
export const TOPIC_MANIFEST: Pick<Topic, "id" | "subject" | "topic_title" | "exam_board" | "topic_number" | "tier_level">[] = [
    ...
    { id: "edexcel_maths_ratio_proportion", subject: "maths", exam_board: "edexcel", topic_title: "Number: Fractions, Decimals, Percentages", topic_number: "1.2", tier_level: "both" },
    { id: "edexcel_maths_algebra_basics", subject: "maths", exam_board: "edexcel", topic_title: "Algebra: Notation and Equations", topic_number: "2.1", tier_level: "both" },
    { id: "edexcel_maths_functions_graphs", subject: "maths", exam_board: "edexcel", topic_title: "Algebra: Graphs", topic_number: "2.2", tier_level: "both" },
    { id: "edexcel_maths_ratio_proportion", subject: "maths", exam_board: "edexcel", topic_title: "Ratio and Proportion", topic_number: "3.1", tier_level: "both" },
    ...
    { id: "edexcel_maths_geometry_angles", subject: "maths", exam_board: "edexcel", topic_title: "Geometry: Measures and Mensuration", topic_number: "4.2", tier_level: "both" },
    ...
    // SCIENCE (Biology)
    { id: "aqa_science_cell_biology", subject: "combined_science", exam_board: "aqa", topic_title: "Biology: Cell Biology", topic_number: "B1", tier_level: "both" },
    ...
    { id: "aqa_science_forces", subject: "combined_science", exam_board: "aqa", topic_title: "Physics: Forces", topic_number: "P5", tier_level: "both" },
    ...
    // ENGLISH LIT
    { id: "aqa_english_lit_macbeth", subject: "english_literature", exam_board: "aqa", topic_title: "Shakespeare: Macbeth / Romeo & Juliet", topic_number: "1", tier_level: "both" },
    ...
    { id: "aqa_english_lit_aic", subject: "english_literature", exam_board: "aqa", topic_title: "Modern Text: An Inspector Calls", topic_number: "3", tier_level: "both" },
    ...
    // ENGLISH LANG
    { id: "aqa_english_lang_paper1", subject: "english_language", exam_board: "aqa", topic_title: "Paper 1: Creative Reading", topic_number: "1.1", tier_level: "both" },
    ...
    // HISTORY
    { id: "aqa_history_medicine", subject: "history", exam_board: "aqa", topic_title: "Thematic Study: Medicine Through Time", topic_number: "1", tier_level: "both" },
    { id: "aqa_history_elizabeth", subject: "history", exam_board: "aqa", topic_title: "British Depth Study: Elizabethan England", topic_number: "2", tier_level: "both" },
    ...
    // RELIGIOUS STUDIES
    { id: "aqa_re_christianity_practices", subject: "religious_studies", exam_board: "aqa", topic_title: "Christianity: Beliefs & Practices", topic_number: "1", tier_level: "both" },
    ...
    { id: "aqa_geography_coasts", subject: "geography", exam_board: "aqa", topic_title: "Physical Landscapes in the UK", topic_number: "1.3", tier_level: "both" },
    ...
    // COMPUTER SCIENCE
    { id: "aqa_cs_algorithms", subject: "computer_science", exam_board: "aqa", topic_title: "Algorithms", topic_number: "3.1", tier_level: "both" },
    ...
    { id: "aqa_combined_science_bio_human_body", subject: "combined_science", exam_board: "aqa", topic_title: "Biology: Human Body Systems", topic_number: "B8", tier_level: "both" },
    { id: "aqa_combined_science_chem_organic_reactions", subject: "combined_science", exam_board: "aqa", topic_title: "Chemistry: Organic Reactions", topic_number: "C11", tier_level: "higher" },
    { id: "aqa_english_language_media_digital", subject: "english_language", exam_board: "aqa", topic_title: "Media & Digital Communication", topic_number: "4", tier_level: "both" },
    { id: "aqa_english_literature_romantic_poetry", subject: "english_literature", exam_board: "aqa", topic_title: "Romantic Poetry Anthology", topic_number: "6", tier_level: "both" },
    { id: "aqa_english_literature_gothic_horror", subject: "english_literature", exam_board: "aqa", topic_title: "Gothic Literature Depth Study", topic_number: "7", tier_level: "both" },
    { id: "aqa_history_hist_migration_empire", subject: "history", exam_board: "aqa", topic_title: "Migration, Colonialism & Empire", topic_number: "5", tier_level: "both" },
    { id: "aqa_business_bus_innovation", subject: "business", exam_board: "aqa", topic_title: "Innovation & Entrepreneurship", topic_number: "7", tier_level: "both" },
    { id: "aqa_french_culture_francophone_world", subject: "french", exam_board: "aqa", topic_title: "Francophone Culture", topic_number: "4", tier_level: "both" },
    { id: "aqa_french_tech_digital_society", subject: "french", exam_board: "aqa", topic_title: "Technology & Society", topic_number: "5", tier_level: "both" },
    { id: "aqa_french_social_issues_contemporary", subject: "french", exam_board: "aqa", topic_title: "Contemporary Social Issues", topic_number: "6", tier_level: "both" },
    { id: "aqa_religious_studies_applied_ethics", subject: "religious_studies", exam_board: "aqa", topic_title: "Applied Ethics & Bioethics", topic_number: "5", tier_level: "higher" },
    { id: "aqa_religious_studies_interfaith_dialogue", subject: "religious_studies", exam_board: "aqa", topic_title: "Interfaith Dialogue", topic_number: "6", tier_level: "higher" },
    { id: "aqa_geography_climate_change_impacts", subject: "geography", exam_board: "aqa", topic_title: "Climate Change Impacts", topic_number: "1.4", tier_level: "both" },
    { id: "aqa_geography_water_insecurity", subject: "geography", exam_board: "aqa", topic_title: "Global Water Insecurity", topic_number: "1.5", tier_level: "both" },
    { id: "aqa_computer_science_ai_machine_learning", subject: "computer_science", exam_board: "aqa", topic_title: "AI & Machine Learning", topic_number: "3.9", tier_level: "higher" },
    { id: "aqa_computer_science_cybersecurity_cryptography", subject: "computer_science", exam_board: "aqa", topic_title: "Advanced Cryptography", topic_number: "3.10", tier_level: "higher" },
];
